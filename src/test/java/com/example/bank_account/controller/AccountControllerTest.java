...
class AccountControllerTest {
    ...
    // then
        mockMvc.perform(get("/account?user_id=2"))
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$[1].accountNumber").value("1111111111"))
                .andExpect(MockMvcResultMatchers.jsonPath("$[1].balance").value(1000))
                .andExpect(MockMvcResultMatchers.jsonPath("$[2].accountNumber").value("2222222222"))
                .andExpect(MockMvcResultMatchers.jsonPath("$[2].balance").value(1000));
    }
    @Test
